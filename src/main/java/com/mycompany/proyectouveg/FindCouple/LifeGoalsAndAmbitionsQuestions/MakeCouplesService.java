...
public class MakeCouplesService {
    ...
    public life_and_ambitions_states_man getMenLifeAndAmbitionsCouple() {
        final life_and_ambitions_states_woman life_and_ambitions = (life_and_ambitions_states_woman) this.user.getLifeAndAmbitions();
    ...
    public life_and_ambitions_states_woman getWomenLifeAndAmbitionCouple() {
        final life_and_ambitions_states_man life_and_ambitions_state = (life_and_ambitions_states_man) this.user.getLifeAndAmbitions();
