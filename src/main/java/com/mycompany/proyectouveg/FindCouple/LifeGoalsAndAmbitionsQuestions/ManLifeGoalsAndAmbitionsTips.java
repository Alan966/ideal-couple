...
public class ManLifeGoalsAndAmbitionsTips implements TipsToGetCouple {
    ...
    public ManLifeGoalsAndAmbitionsTips(User _user) {
        this.user = _user;
    }
    ...
    public String[] getTips() {
        ...
        final life_and_ambitions_states_man life_and_ambitions_state = (life_and_ambitions_states_man) this.life_and_ambitions_states;

        return switch (life_and_ambitions_state) {
            case highly_ambitious_supportive_partner -> tips_life_and_ambitions[0];
            case balanced_team_oriented_partner -> tips_life_and_ambitions[1];
            case more_traditional_family_focused -> tips_life_and_ambitions[2];
