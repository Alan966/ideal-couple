...
public class WomanTipsGetCouple implements TipsToGetCouple {
    private User user;
    ...
    public WomanTipsGetCouple(User user){
        this.user = user;
    }
    ...
    public String[] getTips() {
        switch (this.life_and_social_preferences){
            ...
            case life_and_social_preferences_states_woman.socially_flexible_partner:
                return tips_life_social_preference_woman[1];
            case life_and_social_preferences_states_woman.home_oriented_partner:
                return tips_life_social_preference_woman[2];
            default:
                return tips_life_social_preference_woman[3];
        }
    }
}
