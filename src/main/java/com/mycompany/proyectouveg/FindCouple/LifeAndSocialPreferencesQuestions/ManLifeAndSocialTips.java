...
"Expand Your comfort Zone: Make a effort to attend both lively and quiet gatherings, observing what suits different social contexts",
    ...
    public String[] getTips() {
        if (this.life_and_social_preferences_states == null) {
            ...
            switch (this.life_and_social_preferences_states) {
                case life_and_social_preferences_states_man.socially_driver_partner:
                    return tips_life_social_preference_mens[0];
                case life_and_social_preferences_states_man.socially_flexible_partner:
                    return tips_life_social_preference_mens[1];
                case life_and_social_preferences_states_man.family_oriented_partner:
                    return tips_life_social_preference_mens[2];
                default:
                    return tips_life_social_preference_mens[3];
            }
        }
}
