...
public class WomanLoveLenguageTips implements TipsToGetCouple {
    ...
    public WomanLoveLenguageTips(User _user) {
        this.user = _user;
    }
    ...
    public String[] getTips() {
        ...
        love_lenguage_states_woman love_lenguage_state = (love_lenguage_states_woman) this.love_lenguage_states;
        return switch (love_lenguage_state) {
            case warm_affection_partner -> tips_life_and_ambitions[0];
            case balanced_supportive_partner -> tips_life_and_ambitions[1];
            case low_key_independent_partner -> tips_life_and_ambitions[2];
